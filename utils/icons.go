...
var (
	...
	ICONS = map[string]string{
		"xls":    "https://img.icons8.com/color/96/null/xls.png",
		...
		"pdf":    "https://img.icons8.com/color/96/null/pdf.png",
		...
		"db":     "https://img.icons8.com/color/48/null/realtime-database.png",
	}
)
